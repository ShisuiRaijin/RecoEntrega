document.addEventListener("DOMContentLoaded", function(){
    ...
    pedido.addEventListener("load", function(){
    	...
    	img_tienda0.setAttribute("src", archivoTiendas[0].imagen_tienda);
    	...
    	img_tienda1.setAttribute("src", archivoTiendas[1].imagen_tienda);
    	...
    	img_tienda2.setAttribute("src", archivoTiendas[2].imagen_tienda);
    	...
    	img_tienda3.setAttribute("src", archivoTiendas[3].imagen_tienda);
    	...
    	img_tienda4.setAttribute("src", archivoTiendas[4].imagen_tienda);
    	...
    	img_tienda5.setAttribute("src", archivoTiendas[5].imagen_tienda);
    	...
    	img_tienda6.setAttribute("src", archivoTiendas[6].imagen_tienda);
    	...
    	img_tienda6.setAttribute("src", archivoTiendas[7].imagen_tienda);
    	...
    	img_tienda8.setAttribute("src", archivoTiendas[8].imagen_tienda);
		...
		tienda1_carrousell.setAttribute("src", archivoTiendas[9].imagen_tienda);

		//tienda 2 - carrousell
		var tienda2_carrousell = document.querySelector('#img2_carrousel');
		tienda2_carrousell.setAttribute("src", archivoTiendas[10].imagen_tienda);

		//tienda 3 - carrousell
		var tienda3_carrousell = document.querySelector('#img3_carrousel');
		tienda3_carrousell.setAttribute("src", archivoTiendas[11].imagen_tienda);
    }
,)})
